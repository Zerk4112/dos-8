...
const s_stylePath = 'css/comment-widget-dark.css'; // The path to your CSS file for the widget
const s_formId = '1FAIpQLSeAfN2GU0K4_dafyeeAIrIPSb_Tcz_ssKBm6G_fXoNAxIPbng';
const s_nameId = '1141497010';
const s_websiteId = '1142732096';
const s_textId = '2015368756';
const s_pageId = '405808380';
const s_replyId = '522033693';
const s_sheetId = '1WPlMDrizrtA_q5JTfFrRDq79gSsDU_MZWcxuNx7kb00';
